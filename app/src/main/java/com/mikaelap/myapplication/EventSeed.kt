...
val testEvent1 = schoolEvent(
    ...
    longDescription = "Join Lisa Olshansky for a lecture highlighting current developments in chemistry and how they shape research, innovation, and everyday life.",
...
val testEvent2 = schoolEvent(
    ...
    shortDescription = "▼ TAP FOR DETAILS ▼\nHallie Flanagan Studio Theatre 7:30-9 p.m.",
...
val testEvent4 = schoolEvent(
    title = "Middle East Studies Ketcham Lecture",
    shortDescription = "▼ TAP FOR DETAILS ▼\nSeelye Hall 201 4:30-6 p.m.",
    longDescription = "Join Noura Erakat for the Ketcham Lecture in Middle East Studies. This talk will explore contemporary issues in the region, with a focus on law, human rights, and political advocacy. Open to all students and community members.",
    date = "Thursday, April 16",
    imageRes = R.drawable.erekat
)

val testEvent5 = schoolEvent(
    title = "Smith Arts Day - Exhibits",
    shortDescription = "▼ TAP FOR DETAILS ▼\nAlumnae Gym New Scholarship Studio 11 a.m.-9 p.m.",
...
val testEvent6 = schoolEvent(
    ...
    shortDescription = "▼ TAP FOR DETAILS ▼\nGraham Hall-Hillyer 4:15–5:45 p.m.",
...
val testEvent7 = schoolEvent(
    title = "PHC X Eco Dept Talk: Lucie Schmidt",
    shortDescription = "▼ TAP FOR DETAILS ▼\nSeelye Hall 107 12:15-1:10 p.m.",
    longDescription = "Lucie Schmidt, Chair of Economics will be giving a talk to all interested students in economics and healthcare. ",
    date = "Tuesday, April 21, 2026",
    imageRes = R.drawable.lucie
)

val testEvent8 = schoolEvent(
    title = "Into the Woods",
    shortDescription = "▼ TAP FOR DETAILS ▼\nTheatre 14 7:30-9:30 p.m.",
...
val testEvent9 = schoolEvent(
    title = "Synchro Swim Show",
    shortDescription = "▼ TAP FOR DETAILS ▼\nDalton Swimming Pool 1-8 p.m.",
    longDescription = "Come and support the Smith College Synchronized Swimming team for their end of the semester performance!",
    date = "Saturday, April 25, 2026",
    imageRes = R.drawable.synchro
)

val testEvent10 = schoolEvent(
    title = "Spring Grad Dance Event",
    shortDescription = "▼ TAP FOR DETAILS ▼\nScott Gym Dance Studio 8-9:30 p.m.",
    longDescription = "The Department of Dance presents the Spring Grad Dance Event. Catch an exciting first look at new work by Smith MFA 1st year candidates Michael Figueroa, Lauren Horn, and Lindsey Jones. Seating is limited and reservations are required. Tickets $3",
    date = "Thursday, April 30, 2026",
    imageRes = R.drawable.spring
)
